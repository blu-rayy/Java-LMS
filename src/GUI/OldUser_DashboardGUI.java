...
public class OldUser_DashboardGUI extends JFrame {
    public OldUser_DashboardGUI(String username) {
        // sets taskbar
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new OldUser_DashboardGUI("John Doe")); // Replace "John Doe" with the actual username
    }
}
